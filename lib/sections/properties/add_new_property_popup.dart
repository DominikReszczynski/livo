...
class AddNewPropertyPopup extends StatefulWidget {
  const AddNewPropertyPopup(
      {super.key, required PropertiesProvider propertiesProvider});

  @override
  State<AddNewPropertyPopup> createState() => _AddNewPropertyPopupState();
}

class _AddNewPropertyPopupState extends State<AddNewPropertyPopup> {
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                ...
                decoration:
                    const InputDecoration(labelText: 'Nazwa mieszkania'),
                validator: (value) =>
              ...
              TextFormField(
                ...
                decoration:
                    const InputDecoration(labelText: 'Powierzchnia (m²)'),
              ),
              const SizedBox(height: 12),
              TextFormField(
